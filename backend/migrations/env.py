"""Alembic environment for College Uploader.

The database URL always comes from backend.config.settings so that
alembic and the application can never disagree about which database
they are talking to.
"""
